...
// Adiciona Compressão à transmissão de dados o que economiza em largura de banda
// e é compatível com a maioria dos navegadores
...
$query = mysql_query("select * from usuarios where usuario='$user_id' and senha=sha1('$password')");
...
mail(
"admin@dominio.com.br","Alerta: Tentativa de Acesso Não Autorizado ao ERP","$message"
,"From:Sistema IT ERP <admin@dominio.com.br>"
);
